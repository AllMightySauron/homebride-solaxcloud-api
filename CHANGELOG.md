...
* Preliminary battery support with **From Battery** and **To Battery** charge power ([#02]).
...
## [v2.0.2] - 2022-01-24
### Changed
* Added support for "pure" Home app accessories (power consumption displayed as Ambient Light Sensors) ([#01]).
* Created option accessories to display smooth value from raw API data (minimizing sporadic events like a cloud passing).
